...
#define MOTOR_LIMIT_CLOSE_Pin GPIO_PIN_7
#define MOTOR_LIMIT_CLOSE_GPIO_Port GPIOA
#define MOTOR_LIMIT_CLOSE_EXTI_IRQn EXTI9_5_IRQn
#define MOTOR_LIMIT_REMOTE_Pin GPIO_PIN_8
#define MOTOR_LIMIT_REMOTE_GPIO_Port GPIOA
#define MOTOR_LIMIT_REMOTE_EXTI_IRQn EXTI9_5_IRQn
